...
public class TAUtils {
     ...
     * atual não tendo em conta os pedidos pendentes atuais e posições abertas. Ele permite a avaliação da margem para a
     ...
     */
    public static double calcOrderMargin(double volume, double price, double leverage) {
        // Margem necessária = Tamanho da operação (trade) / Alavancagem * Taxa cambial da conta
        return (volume * STANDARD) / leverage * price;
    }
